...
export default async function MatchScoringPage({ params, searchParams }: PageProps) {
  ...
  const { data: match } = await supabase
    .from('matches')
    .select('*, match_format, player1:player1_id(id,name,seed,club,partner_name), player2:player2_id(id,name,seed,club,partner_name), winner:winner_id(id,name,seed,partner_name)')
